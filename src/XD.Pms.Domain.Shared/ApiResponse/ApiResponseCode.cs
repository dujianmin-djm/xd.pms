...
public static class ApiResponseCode
{
	...
	/// 用户名或密码错误
	/// </summary>
	public const string InvalidCredentials = "40002";
	...
	/// Token 已被撤销
	/// </summary>
	public const string AccessTokenRevoked = "40103";

	/// <summary>
	/// Refresh Token 无效
	/// </summary>
	public const string RefreshTokenInvalid = "40104";

	/// <summary>
	/// Refresh Token 过期
	/// </summary>
	public const string RefreshTokenExpired = "40105";

	/// <summary>
	/// Refresh Token 已被使用（可能存在重放攻击，需重新登录）
	/// </summary>
	public const string RefreshTokenRedeemed = "40106";

	/// <summary>
	/// 账户已被禁用
	/// </summary>
	public const string AccountDisabled = "40107";

	/// <summary>
	/// 账户已被锁定（登录失败次数过多）
	/// </summary>
	public const string AccountLocked = "40108";

	/// <summary>
	/// 强制登出 - 密码已修改
	/// </summary>
	public const string PasswordChanged = "40109";

	/// <summary>
	/// 强制登出 - 被管理员踢出
	/// </summary>
	public const string KickedOut = "40110";
